...
o	Modelo de Chat: Ex: gpt-35-turbo ou gpt-4.
o	Modelo de Embeddings: Ex: text-embedding-3-small (necessário para transformar texto em vetores).
...
•	Realize perguntas no chat interativo para validar se as respostas estão sendo fundamentadas nos PDFs carregados.________________________________________
📈 Insights Aprendidos
